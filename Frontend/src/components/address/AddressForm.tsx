...
import { addressSchema, type AddressInput } from "../../lib/validation/address.schema";
...
export default function AddressForm({ onSubmit, onCancel }: AddressFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 border border-border rounded-xl p-4">
      <div>
      ...
      <div>
        <label className="block text-sm font-medium text-text-muted mb-1.5">Address line 1</label>
        <input
      ...
      <div>
        <label className="block text-sm font-medium text-text-muted mb-1.5">Address line 2 (optional)</label>
        <input
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          <label className="block text-sm font-medium text-text-muted mb-1.5">Postal code</label>
          <input
            {...register("postalCode")}
            className="w-full bg-surface-2 border placeholder:text-text-subtle rounded-lg px-4 py-2.5 outline-none focus:border-primary focus:ring-1 focus:ring-primary"
          />
